...
class LinkWithoutConfigurationTest < ActionDispatch::IntegrationTest
  ...
  test "should render default meta tags" do
    ...
    assert_select "meta[itemprop='name'][content='Smash!']", 1
    ...
    assert_select "meta[property='og:title'][content='Smash!']", 1
    ...
    assert_select "meta[property='twitter:title'][content='Smash!']", 1
